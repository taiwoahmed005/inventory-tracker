        ...
        <div class="contentcontainer" id="contentcontainer">
            ...
            <div class="content">
                <div class="maincontent">
                    <?php
                        ...
                        $selectedDate = "";
                            ...
                            if($_SERVER["REQUEST_METHOD"] == "POST"){
                                ...
                                if(empty($_REQUEST["income_date"])){
                                    $selectedDateErr =" <p style='color:red'>* Please Select a Date</p>";
                                } else {
                                    $selectedDate = trim($_REQUEST["income_date"]);
                                } 
                                ...
                                if(!empty($selectedDate)){
                                    ...
                                    $sql_query = "SELECT date , amount FROM income WHERE date = '$selectedDate' AND email = '$_SESSION[email]' ";
                    ...
                    <div class="container" > 
                        <h3  class="text-center pt-5 hide">Daywise Income Report</h3>
                    ...
                    <!-- Adding content into table -->
                                    <?php  
                                        if($rows > 0){
                                            ...
                                            // echo $date;
                                            $amount =  $rows["amount"];
                                            echo " <tr> <th> {$i}. </th> <th> {$date} </th> <th> {$amount} </th> ";
                                            $i++;
                                            // closing while loop
                                    } 
                                        echo "   </tbody> </table>";
                                        ...
                                        // showing button to redirect daywise page
                                        echo " <div class='text-center pt-4 pb-5'> <a href='daywise-in.php' class='btn btn-primary btn-lg'> Check More </a> 
                        ...
                        <div id="form" class="pt-5 form-input-content">
                            <div class="card login-form mb-0">
                                <div class="card-body pt-5 shadow">
                                    <h4 class="text-center">Daywise Income Report </h4>
                                    <form method="POST" action=" <?php htmlspecialchars($_SERVER['PHP_SELF']) ?>">            
                                        <div class="form-group">
                                            <label >Select A Date for Income Report:</label>
