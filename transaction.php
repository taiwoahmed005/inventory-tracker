        ...
        <div class="contentcontainer" id="contentcontainer">
            ...
            <div class="content">
                <div class="maincontent">
                    <div class="export">
                        <a href="export.php"style="text-decoration:none;margin:10px;padding:10px;color:#fff;">Export</a>
                        
                    </div>
                        <center><h3 class="tran">Transaction</h3></center>

                        <?php
                        include 'include/trans_short_cut.php'
                        ?>
                </div>
            </div>
        </div>
