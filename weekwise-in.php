                        ...
                        $firstDay= $lastDay = "";
                            ...
                            if($_SERVER["REQUEST_METHOD"] == "POST"){
                                ...
                                $lastDayErr = " <p style='color:red'>* Please Select a Operation </p>";
                                    ...
                                    <div class='container '> 
                                        <h4 class='text-center pt-5 hide'>Weekwise Income Report </h4>
                                                    ...
                                                    <tbody>
                                                        <?php 
                                                            ...
                                                            while($rows = mysqli_fetch_assoc($result)){
                                                                ...
                                                                echo "<div class='text-center pt-4 pb-5'> <a href='weekwise-in.php' class='btn btn-primary btn-lg'> Check More </a>
                        ...
                        <div id="form" class="pt-5 form-input-content">
                            <div class="card login-form mb-5">
                                <div class="card-body pt-5 bg-white shadow">
                                    <h4 class="text-center">Weekwise Income Report </h4>
