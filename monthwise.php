        ...
        <div class="contentcontainer" id="contentcontainer">
            ...
            <div class="content">
                <div class="maincontent">
                    ...
                    <div class='container '> 
                        <h4 class='text-center pt-5 hide'>Monthwise Expense Report </h4>
                            <table class='table table-bordered table-hover border-primary mt-5 bg-light shadow hide'>
                                ...
                                <tbody>
                                    <?php 
                                        ...
                                        $item =  $rows["item"];
                                        $price =  $rows["price"];
                                        echo "<tr> <th> $i   </th> <th>  $date  </th> <th>" .  ucwords($item) . " </th> <th>   $price</th> </tr> ";
                                        $i++;
                                } 
                                    echo "</tbody> </table> ";
                                    echo "<style> #form{ display:none } </style>";
                                    echo "<div class='text-center pt-4 pb-5'> <a href='monthwise.php' class='btn btn-primary btn-lg'> Check More </a> 
                                ...
                                <div id="form" class="pt-5 form-input-content">
                                            <div class="card login-form mb-0">
                                                <div class="card-body pt-5 shadow">
                                                        <h4 class="text-center">Month Expense Report </h4>
